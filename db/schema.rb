...
ActiveRecord::Schema[7.1].define(version: 2025_01_24_003714) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["surfboard_id"], name: "index_favorites_on_surfboard_id"
  ...
  add_foreign_key "favorites", "surfboards"
